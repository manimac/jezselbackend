...
const StaffingRegisterModel = (sequelize, Sequelize) => {
    const StaffingRegister = sequelize.define('StaffingRegister', {
    ...
    return StaffingRegister
}

module.exports = StaffingRegisterModel